...
from sqlalchemy import (
    String, Text, Boolean, DateTime, ForeignKey, func, text
)
...
class User(Base):
    ...
    contest_accesses: Mapped[list["ContestAccess"]] = relationship("ContestAccess", back_populates="user")
...
class Contest(Base):
    ...
    access_records: Mapped[list["ContestAccess"]] = relationship("ContestAccess", back_populates="contest")
...
class Task(Base):
    ...
    contest_id: Mapped[uuid.UUID | None] = mapped_column(ForeignKey("contest.id"), nullable=True)
...
class ContestAccess(Base):
    ...
    contest_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("contest.id"), nullable=False)
